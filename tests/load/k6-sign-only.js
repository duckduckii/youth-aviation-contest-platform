...
export default function () {
  ...
  signFile('report', 'load-test-report.pdf', 'application/pdf', 1024);
  signFile('proof1', 'load-test-proof1.pdf', 'application/pdf', 1024);
  signFile('integrity', 'load-test-integrity.pdf', 'application/pdf', 1024);

  if (INCLUDE_OPTIONAL_VIDEO) {
    signFile('proof2', 'load-test-proof2.mp4', 'video/mp4', 1024);
  }
}
